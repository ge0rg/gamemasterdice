...
public class GameMasterDice extends ListActivity implements OnClickListener, OnLongClickListener {

	private static String TAG = "GameMasterDice";

	// map button IDs to dice
	int button_ids[] = { R.id.die0, R.id.die1, R.id.die2, R.id.die3, R.id.die4 };
	Button buttons[];
	Button button_more;
	int button_colors[] = { 0xffff9800, 0xffffc107, 0xffcddc39, 0xff8bc34a, 0xff4caf50, 0xff009688, 0xff424242 };
	TextView resultview;
	...
	DiceSet button_cfg[] = {
		...
		DiceSet.getDiceSet(1, 4, 0),
		DiceSet.getDiceSet(1, 3, 0)
	};
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		for (int i = 0; i < button_ids.length; i++) {
			...
			buttons[i].getBackground().setColorFilter(button_colors[6], PorterDuff.Mode.MULTIPLY);
		}
		button_more = (Button)findViewById(R.id.more);
		button_more.setOnClickListener(this);
		button_more.getBackground().setColorFilter(button_colors[6], PorterDuff.Mode.MULTIPLY);
